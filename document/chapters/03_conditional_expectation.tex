...
\begin{lemma}
	...
	\[
		\normalfont\texttt{has\_cond\_exp} \; M \; F \; (\mathbf{1}_A \cdot_\mathbb{R} y) \; ((\texttt{real\_cond\_exp} \; M \; F \; \mathbf{1}_A) \cdot_\mathbb{R} y)
	\]
\end{lemma}
\begin{proof}
...
\begin{lemma} (Contraction for Simple Functions)
