...
If an integrable function $f$ is already $F$-measurable, then ``$\texttt{cond\_exp} \; M \; F \; f = f$'' $\mu$-a.e. This is a corollary of the lemma on the characterization of \texttt{cond\_exp}.
\begin{isacorollary}
{\small
	\begin{lstlisting}[style=isabelle]
