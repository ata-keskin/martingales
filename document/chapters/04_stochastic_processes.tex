...
We state the definition of a stochastic process again, and subsequently introduce the corresponding locale.
...
In more detail we define a filtration as follows. 
\begin{definition}
