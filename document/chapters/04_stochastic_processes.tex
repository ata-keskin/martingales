...
We state the definition of a stochastic process.
...
\begin{proof}
	...
	Let $n \in \mathbb{N}$ and let $S \subseteq E$ be an open set. Consider the map $\psi$ defined by $\psi(i,x) = X_i(x)$. We have
	\[
